...
KEEP_EVAL_CACHE=1 EVAL_CKPT_DIR="/home/hooved/stable_diffusion/checkpoints/training_checkpoints/09091752/run_eval_9144" RUNMLPERF=1 python3 examples/mlperf/model_train.py
